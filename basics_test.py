#all functions should run in a loop repeatedly unless the keyword "Iquit:P" is typed in at any point in time. no external online help or external libraries :)
"""
Q_1, 
...
This table also should be positioned in the way that the smallest value is in the top-right corner and the highest value in the bottom-right corner.
